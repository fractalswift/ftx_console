...
def check_result(_result):
    ...
    vs = _result.lr1[0]
    vs_pct_90 = _result.cvt[0][0]
    vs_pct_95 = _result.cvt[0][1]
    vs_pct_99 = _result.cvt[0][2]
    
    ev = result.lr2[0]
    ev_pct_90 = _result.cvm[0][0]
    ev_pct_95 = _result.cvm[0][1]
    ev_pct_99 = _result.cvm[0][2]
